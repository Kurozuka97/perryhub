...
function ChannelCard({
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          ...
          observer.disconnect() // check sekali je
        }
      },
      { threshold: 0.1 }
    )
  ...
  function getDotGlow() {
    return streamStatus === 'live' ? '0 0 6px #00ff88' : 'none'
  }
    ...
    >
      <div className="flex items-center gap-3 mb-2">
        {channel.logo ? (
          ...
          <div style={{
            ...
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#00c9c9" strokeWidth="2">
      ...
      <div className="flex items-center justify-between">
        ...
        <div
          ...
          style={{ background: getDotColor(), boxShadow: getDotGlow() }}
        />
      </div>
    </motion.button>
  )
